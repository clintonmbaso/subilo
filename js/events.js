     ...
     // Month 1
            { 
               name: "Circle Starts", 
               date: new Date("Jul 5, 2025 08:00:00").getTime(), 
               reminderDays: 2, 
               reminderHours: 12, 
               caption: "Circle Starts", 
               details: "This marks the official beginning of our circle number 7.", 
     ...
     // Month 3
             { name: "Month 3 begins", 
               date: new Date("Sep 5, 2025 08:00:00").getTime(), 
               reminderDays: 2, reminderHours: 12,
     ...
     // Month 5
             { name: "Month 5 begins", 
               date: new Date("Nov 5, 2025 08:00:00").getTime(), 
               reminderDays: 2, reminderHours: 12,
     ...
     // Month 6
             { name: "Month 6 begins", 
               date: new Date("Dec 5, 2025 08:00:00").getTime(), 
               reminderDays: 2, reminderHours: 12,
     ...
     // Month 7
             { name: "Share Out", 
               date: new Date("Jan 5, 2026 08:00:00").getTime(), 
               reminderDays: 2, reminderHours: 12,
